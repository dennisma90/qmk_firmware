...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT( /* Colemak-DH */
    ...
    KC_Z,    KC_X,     KC_C,    KC_D,    KC_V,                          KC_K,    KC_H,        KC_COMM,     KC_DOT,      KC_SLSH,
                         LT(_NUMB, KC_BSPC), LT(_SYMB, KC_ENT),         LT(_NAVG, KC_TAB), LT(_FUNC, KC_SPC)
  ),
  ...
  [_NUMB] = LAYOUT(
       QK_BOOT,    ____,    ____,    ____,   ____,                     KC_LBRC, KC_7, KC_8, KC_9, KC_RBRC,
  ...
  [_FUNC] = LAYOUT(
    KC_F12, KC_F7, KC_F8, KC_F9, KC_PSCR,                      ____,       ____,    ____,    ____,    QK_BOOT,
